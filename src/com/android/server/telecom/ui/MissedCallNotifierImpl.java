...
public class MissedCallNotifierImpl extends CallsManagerListenerBase implements MissedCallNotifier {
    ...
    private static void configureLedNotification(Context context, Notification notification) {
        ...
        boolean lightEnabled = SlimSettings.System.getInt(resolver,
                SlimSettings.System.NOTIFICATION_LIGHT_PULSE, 0) == 1;
        if (!lightEnabled) {
            return;
        }
        ...
        boolean customEnabled = SlimSettings.System.getInt(resolver,
                SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CUSTOM_ENABLE, 0) == 1;
        if (!customEnabled) {
            notification.defaults |= Notification.DEFAULT_LIGHTS;
            return;
        }

        notification.ledARGB = SlimSettings.System.getInt(resolver,
            SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_COLOR, DEFAULT_COLOR);
        notification.ledOnMS = SlimSettings.System.getInt(resolver,
            SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_ON, DEFAULT_TIME);
        notification.ledOffMS = SlimSettings.System.getInt(resolver,
            SlimSettings.System.NOTIFICATION_LIGHT_PULSE_CALL_LED_OFF, DEFAULT_TIME);
    }
